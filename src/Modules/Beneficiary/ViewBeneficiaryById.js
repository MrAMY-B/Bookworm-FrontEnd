...
function ViewBeneficiaryById() {

    let {ban_id} = useParams('ban_id'); 
    const [user,setUser] = useState({})
    
    useEffect(() => {
       fetch(API+'/beneficiary/'+ban_id).then(res => res.json()).then(res=>setUser(res))
...
export default ViewBeneficiaryById
